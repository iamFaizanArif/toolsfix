...
const PricingCard = (props) => {
    return (
        <div className={`flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg shadow white:border-gray-600 xl:p-8 white:bg-gray-800 white:text-white border w-full ${props.styles}`}>
            ...
            <a href='https://app.toolsfix.net/signup' className="text-white hover:text-[#454545] bg-[#454545] hover:bg-white  font-bold rounded-full py-3 w-full lg:w-[85%] ml-0 lg:ml-[8%] text-center text-lg white:text-white hover:shadow-custom hover:border-[#454545] border-4">Get Started Now</a>
        </div>
    )
}
